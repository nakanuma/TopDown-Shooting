...
private:
	...
	static constexpr Float2 kTitlePosition = { 640.0f, 140.0f };		/* タイトル位置 */
	static constexpr Float2 kStartButtonPosition = { 640.0f, 580.0f };	/* スタートボタン位置 */
	...
	static constexpr Float3 kCameraTargetPosition = { 0.0f, 0.0f, 0.0f };	/* カメラのターゲット位置 */
	...
	static constexpr Float2 kTitleBasePosition = { 640.0f, 140.0f };	/* タイトルスプライトの基準位置 */
	...
	static constexpr Float4 kStartButtonBaseColor = { 1.0f, 1.0f, 1.0f, 1.0f };	/* スタートボタンの色 */

	static constexpr int32_t kSmokeEmitInterval = 5;					/* 煙パーティクルを発生させる間隔（フレーム） */
	static constexpr int32_t kSmokeEmitCount = 1;						/* 煙パーティクルの発生数 */
	static constexpr Float3 kSmokePosition1 = { 12.0f, 4.0f, -12.0f };	/* 煙パーティクル発生位置1 */
	static constexpr Float3 kSmokePosition2 = { -14.0f, 4.0f, 12.0f };	/* 煙パーティクル発生位置2 */
	static constexpr Float3 kSmokePosition3 = { 34.0f, 4.0f, 8.0f };	/* 煙パーティクル発生位置3 */

	static constexpr int32_t kSparkEmitCount = 5;						/* 火花パーティクルの発生数 */
	static constexpr Float3 kSparkPosition1 = { 25.0f, 4.0f, 16.0f };	/* 火花パーティクル発生位置1 */
	static constexpr Float3 kSparkPosition2 = { -31.0f, 3.0f, 11.0f };	/* 火花パーティクル発生位置2 */
	static constexpr Float3 kSparkPosition3 = { -31.0f, 4.0f, -26.0f };	/* 火花パーティクル発生位置3 */
	static constexpr Float3 kSparkDirection1 = { 1.0f, 0.0f, 0.0f };	/* 火花パーティクル方向1 */
	static constexpr Float3 kSparkDirection2 = { -1.0f, 0.0f, 0.0f };	/* 火花パーティクル方向2 */
	static constexpr Float3 kSparkDirection3 = { -1.0f, 0.0f, 0.0f };	/* 火花パーティクル方向3 */
