...
void Field::Initialize()
{
	...
	objectFloor_->transform_.scale = { 30.0f, 30.0f, 1.0f };
...
void Field::Draw()
{
	...
	ImGui::Begin("a");
	ImGui::DragFloat3("a", &objectFloor_->transform_.rotate.x, 0.01f);
	ImGui::DragFloat3("b", &objectFloor_->transform_.scale.x, 0.01f);
	ImGui::End();
}
