...
void PowerGeneratorHPBar::Initialize(Cygnus::SpriteCommon* spriteCommon) {
	// HPバー後景スプライト生成
...
void PowerGeneratorHPBar::Update(const Cygnus::Float3& worldPos, float hpRatio) {
	// ワールド座標をスクリーン座標に変換
