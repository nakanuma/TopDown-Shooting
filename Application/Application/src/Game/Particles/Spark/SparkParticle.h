...
protected:
	...
	SparkParticleData CreateParticle(const Float3& pos, const Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Float3 kInitialScale = { 0.04f, 0.04f, 0.8f };		/* 初期スケール */
