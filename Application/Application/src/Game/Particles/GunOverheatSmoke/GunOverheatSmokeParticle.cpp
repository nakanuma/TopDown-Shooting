#include "GunOverheatSmokeParticle.h"

// Engine
#include <Engine/Math/Easing.h>
#include <Engine/Util/RandomGenerator.h>

GunOverheatSmokeParticle::GunOverheatSmokeParticle(Cygnus::ModelManager::ModelData& model) {
	// オブジェクト設定
...
GunOverheatSmokeParticleData GunOverheatSmokeParticle::CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) {
	GunOverheatSmokeParticleData p;
...
void GunOverheatSmokeParticle::UpdateParticle(GunOverheatSmokeParticleData& p, float dt) {
