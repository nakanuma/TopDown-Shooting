...
BackscatterParticle::BackscatterParticle(Cygnus::ModelManager::ModelData& model) {
	// オブジェクト設定
...
BackscatterParticleData BackscatterParticle::CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) {
