...
// ボスのミサイル爆発後に発生
// =========================================================
class ExplodeSmokeParticle : public Cygnus::BaseParticleEffect<ExplodeSmokeParticleData> {
public:
	// =========================================================
	// Public Methods
	// =========================================================
	...
	ExplodeSmokeParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	ExplodeSmokeParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Cygnus::Float3 kMinOffset = {0.0f, 0.0f, 0.0f};			/* 位置の最小オフセット */
	static constexpr Cygnus::Float3 kMaxOffset = {0.0f, 1.0f, 0.0f};			/* 位置の最大オフセット */
	static constexpr Cygnus::Float3 kInitialScale = {0.5f, 0.5f, 0.5f};			/* 初期スケール */
	static constexpr Cygnus::Float3 kMinVelocity = {-5.0f, -5.0f, -5.0f};		/* 最小速度ベクトル */
	static constexpr Cygnus::Float3 kMaxVelocity = {5.0f, 5.0f, 5.0f};			/* 最大速度ベクトル */
	static constexpr Cygnus::Float4 kInitialColor = {1.0f, 1.0f, 0.0f, 1.0f};	/* 初期色（黄） */
	static constexpr float kMinLifeTime = 2.0f;									/* 最小生存時間 */
	...
	static constexpr float kEndScale = 1.0f;									/* 最終スケール */
	...
	static constexpr float kColorPhase3Duration = 0.5f;  /* 色変更フェーズ3の期間 */
