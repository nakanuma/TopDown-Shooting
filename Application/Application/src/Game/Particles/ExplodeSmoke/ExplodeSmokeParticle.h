...
protected:
	...
	ExplodeSmokeParticleData CreateParticle(const Float3& pos, const Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Float3 kMinOffset = {0.0f, 0.0f, 0.0f};           /* 位置の最小オフセット */
	static constexpr Float3 kMaxOffset = {0.0f, 1.0f, 0.0f};           /* 位置の最大オフセット */
	static constexpr Float3 kInitialScale = {0.5f, 0.5f, 0.5f};        /* 初期スケール */
	static constexpr Float3 kMinVelocity = {-5.0f, -5.0f, -5.0f};      /* 最小速度ベクトル */
	static constexpr Float3 kMaxVelocity = {5.0f, 5.0f, 5.0f};         /* 最大速度ベクトル */
	...
	static constexpr Float4 kColorGray = {0.1f, 0.1f, 0.1f, 1.0f};   /* 灰色 */
};
