...
protected:
	...
	MissileSmokeParticleData CreateParticle(const Float3& pos, const Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Float3 kMinOffset = {-0.4f, -0.4f, -0.4f};       /* 最小位置オフセット */
	static constexpr Float3 kMaxOffset = {0.4f, 0.4f, 0.4f};          /* 最大位置オフセット */
	static constexpr Float3 kInitialScale = {0.2f, 0.2f, 0.2f};       /* 初期スケール */
	static constexpr Float3 kMinVelocity = {-1.0f, -1.0f, -1.0f};     /* 最小速度ベクトル */
	static constexpr Float3 kMaxVelocity = {1.0f, 1.0f, 1.0f};        /* 最小速度ベクトル */
