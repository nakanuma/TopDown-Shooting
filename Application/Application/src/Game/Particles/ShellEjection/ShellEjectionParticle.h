...
// 射撃時に銃からに発生
// =========================================================
class ShellEjectionParticle : public Cygnus::BaseParticleEffect<ShellEjectionParticleData>
{
public:
	// =========================================================
	// Public Methods
	...
	ShellEjectionParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	ShellEjectionParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Cygnus::Float3 kInitialScale = { 0.1f, 0.1f, 0.25f };			/* 初期スケール */
	...
	static constexpr Cygnus::Float4 kInitialColor = { 0.4f, 0.4f, 0.0f, 1.0f };		/* 初期色 */
	static constexpr float kLifeTime = 1.0f;										/* 生存時間（秒） */
	static constexpr Cygnus::Float3 kMinRotationSpeed = { -5.0f, -5.0f, -5.0f };	/* 最小回転速度 */
	static constexpr Cygnus::Float3 kMaxRotationSpeed = { 5.0f, 5.0f, 5.0f };		/* 最大回転速度 */
