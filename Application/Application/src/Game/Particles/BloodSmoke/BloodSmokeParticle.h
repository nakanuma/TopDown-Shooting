...
// 弾が敵に当たったときに発生
// =========================================================
class BloodSmokeParticle : public Cygnus::BaseParticleEffect<BloodSmokeParticleData> {
public:
	// =========================================================
	// Public Methods
	// =========================================================
	...
	BloodSmokeParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	BloodSmokeParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Cygnus::Float3 kPositionOffsetMin = {-0.25f, -0.25f, -0.25f};	/* 位置オフセット最小値 */
	static constexpr Cygnus::Float3 kPositionOffsetMax = {0.25f, 0.25f, 0.25f};		/* 位置オフセット最大値 */
	...
	static constexpr Cygnus::Float4 kInitialColor = {0.25f, 0.0f, 0.0f, 0.75f};		/* 初期色 */
	static constexpr float kMinLifeTime = 0.5f;										/* 最小生存時間（秒） */
	static constexpr float kMaxLifeTime = 0.75f;									/* 最大生存時間（秒） */
	static constexpr Cygnus::Float3 kRotationSpeedMin = {-1.0f, -1.0f, -1.0f};		/* 最小回転速度 */
	static constexpr Cygnus::Float3 kRotationSpeedMax = {1.0f, 1.0f, 1.0f};			/* 最大回転速度 */
