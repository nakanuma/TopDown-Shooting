...
protected:
	...
	SmokeParticleData CreateParticle(const Float3& pos, const Float3& velocity, float angle) override;
...
private:
	...
	static constexpr Float3 kMinVelocity = { -1.0f, -5.0f, -1.0f };			/* 最小速度ベクトル */
	static constexpr Float3 kMaxVelocity = { 1.0f, 5.0f, 1.0f };			/* 最大速度ベクトル */
