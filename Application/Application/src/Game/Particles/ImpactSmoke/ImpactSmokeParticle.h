...
// 弾が障害物に当たったときに発生
// =========================================================
class ImpactSmokeParticle : public BaseParticleEffect<ImpactSmokeParticleData> {
public:
	// =========================================================
	// Public Methods
	// =========================================================
	...
	ImpactSmokeParticle(ModelManager::ModelData& model);
...
protected:
	...
	ImpactSmokeParticleData CreateParticle(const Float3& pos, const Float3& velocity, const float& angle) override;
