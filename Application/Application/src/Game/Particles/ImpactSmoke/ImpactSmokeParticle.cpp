...
ImpactSmokeParticle::ImpactSmokeParticle(Cygnus::ModelManager::ModelData& model) {
	// オブジェクト設定
...
ImpactSmokeParticleData ImpactSmokeParticle::CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) {
