...
// ボスの地面警告攻撃時に発生
// =========================================================
class ExplodeScatterParticle : public Cygnus::BaseParticleEffect<ExplodeScatterParticleData> {
public:
	// =========================================================
	// Public Methods
	// =========================================================
	...
	ExplodeScatterParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	ExplodeScatterParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Cygnus::Float3 kMinScale = {0.2f, 0.2f, 0.2f};				/* 最小スケール */
	static constexpr Cygnus::Float3 kMaxScale = {0.4f, 0.4f, 0.4f};				/* 最大スケール */
	static constexpr Cygnus::Float3 kMinVelocity = {-12.0f, 0.0f, -12.0f};		/* 最小速度ベクトル */
	static constexpr Cygnus::Float3 kMaxVelocity = {12.0f, 8.0f, 12.0f};		/* 最大速度ベクトル */
