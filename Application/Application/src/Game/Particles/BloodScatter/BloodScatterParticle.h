...
// プレイヤーや敵に弾が当たったときに発生
// =========================================================
class BloodScatterParticle : public Cygnus::BaseParticleEffect<BloodScatterParticleData>
{
public:
	// =========================================================
	// Public Methods
	...
	BloodScatterParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	BloodScatterParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
...
private:
	...
	// Constants
	// =========================================================
	static constexpr Cygnus::Float3 kScale = { 0.09f, 0.09f, 0.6f };				/* スケール */
