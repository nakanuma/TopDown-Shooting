...
// プレイヤー死亡時に発生
// =========================================================
class BloodSplatterParticle : public Cygnus::BaseParticleEffect<BloodSplatterParticleData> {
public:
	// =========================================================
	// Public Methods
	// =========================================================
	...
	BloodSplatterParticle(Cygnus::ModelManager::ModelData& model);
...
protected:
	...
	BloodSplatterParticleData CreateParticle(const Cygnus::Float3& pos, const Cygnus::Float3& velocity, float angle) override;
...
private:
	...
	static constexpr Cygnus::Float3 kMinVelocity = {-12.0f, 2.0f, -12.0f};		/* 最小速度ベクトル */
	static constexpr Cygnus::Float3 kMaxVelocity = {12.0f, 4.0f, 12.0f};		/* 最大速度ベクトル */
	static constexpr Cygnus::Float4 kInitialColor = {0.25f, 0.0f, 0.0f, 1.0f};	/* 初期色 */
