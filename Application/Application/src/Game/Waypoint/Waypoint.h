...
public:
	...
	Waypoint(const std::string& name, const Cygnus::Float3& pos, Cygnus::ModelManager::ModelData* model);
	...
	const Cygnus::Float3& GetPosition() const { return position_; }
...
private:
	...
	static constexpr Cygnus::Float4 kColorLightBlue = {0.0f, 1.0f, 1.0f, 1.0f}; /* 水色 */
	...
	Cygnus::Float3 position_;                  /* 位置 */
	std::vector<Waypoint*> neighbors_; /* 隣接ノード */

	// ----- Object -----
	std::unique_ptr<Cygnus::Object3D> objectSphere_; /* ウェイポイント表示用の球体オブジェクト */
};