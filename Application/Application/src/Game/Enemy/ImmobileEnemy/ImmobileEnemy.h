...
// Engine
#include <Engine/BehaviourTree/IBehaviorAgent.h>

/// <summary>
/// 固定敵
/// </summary>
class ImmobileEnemy : public Enemy, public IBehaviorAgent, public ICollisionCallback {
public:
	/// <summary>
	/// 初期化処理
	/// </summary>
	...
	/// 自身のデータを取得
	/// </summary>
	void* GetUserData() override { return this; }
