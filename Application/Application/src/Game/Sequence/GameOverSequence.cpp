...
void GameOverSequence::Debug() {
	...
	const char* phaseStr = "";
	switch (phase_) {
	case GameOverSequence::Phase::None:
		phaseStr = "None";
		break;
	case GameOverSequence::Phase::Intro:
		phaseStr = "Intro";
		break;
	case GameOverSequence::Phase::Approach:
		phaseStr = "Approach";
		break;
	case GameOverSequence::Phase::Rotate:
		phaseStr = "Rotate";
		break;
	case GameOverSequence::Phase::DiedText:
		phaseStr = "DiedText";
		break;
	case GameOverSequence::Phase::BackToTitleText:
		phaseStr = "BackToTitle";
		break;
	case GameOverSequence::Phase::Finish:
		phaseStr = "Finish";
		break;
	}
